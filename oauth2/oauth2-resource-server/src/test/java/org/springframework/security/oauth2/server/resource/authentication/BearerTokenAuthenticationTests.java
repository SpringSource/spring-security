...
public class BearerTokenAuthenticationTests {
	...
	@Before
	public void setUp() {
		this.attributesMap.put(OAuth2TokenIntrospectionClaimNames.SUBJECT, this.name);
	...
	public void getNameWhenTokenHasUsernameThenReturnsUsernameAttribute() {
		...
		assertThat(authenticated.getName())
				.isEqualTo(this.principal.getAttribute(OAuth2TokenIntrospectionClaimNames.SUBJECT));
		// @formatter:on
	}
